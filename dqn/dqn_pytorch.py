# source: https://github.com/pytorch/tutorials/blob/master/intermediate_source/reinforcement_q_learning.py
...
class Agent(object):
    def __init__(self, screen_height, screen_width, n_actions,
                 gamma, epsilon_start, epsilon_end, epsilon_decay, target_update):
